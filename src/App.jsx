    ...
    if (
      ...
      send(
        ...
        .then((response) => {
          ...
          alert(
            `processing your message, ${toSend.from_name}. i'll get back to you soon!`
          );
        })
        .catch((err) => {
      ...
      <section>
        ...
        <div className="project">
          <strong>
            <a
              className="link"
              href="https://devyleague.netlify.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              devyleague fantasy basketball
            </a>
            <br />
          </strong>
          GitHub: <span> </span>
          <a
            className="link"
            href="https://github.com/devin-mullin/basketball-frontend"
            target="_blank"
            rel="noopener noreferrer"
          >
            frontend
          ...
          <a
            className="link"
            href="https://github.com/devin-mullin/basketball-trade-fantasy-backend"
            target="_blank"
            rel="noopener noreferrer"
          >
            backend
          ...
          <a
            className="link"
            href="https://www.youtube.com/watch?v=08BQZd9fZko"
            target="_blank"
            rel="noopener noreferrer"
          >
            demo
          ...
          <br />
          <br />
          frontend built with React, Redux Toolkit, YouTube's API, & a blend of
          ...
          <br />
          <br />
          roadmap includes mobile responsive design, user league creation, trade
          functionality, head-to-head user matchups, & live game score / injury
          updates
          <br />
          <br />
          note: I'm building this because I love basketball, & I don't currently
          have the means or wherewithal to create an NBA 2K alternative, lol
        </div>
        <br />
        <div className="project">
          <strong>
            <a
              className="link"
              href="https://fervent-torvalds-d8a56c.netlify.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              react-ionary
          ...
          <a
            className="link"
            href="https://github.com/devin-mullin/phase-2-project-dictionary/tree/main/dictionary-phase-2"
            target="_blank"
            rel="noopener noreferrer"
          >
            frontend
          ...
          <a
            className="link"
            href="https://www.linkedin.com/in/scott-donnan/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Scott Donnan
          ...
          <br />
          <br />
          built with React, Styled Components, & the Merriam-Webster Dictionary
          API
          <br />
          <br />
          dictionary app ideated with the intention of getting practice with
          deeply nested resources, as well as accessibility functionality
          (specifically the word pronunciation feature)
        </div>
        <br />
        <div className="project">
          <strong>
            <a
              className="link"
              href="https://amazing-liskov-1d721d.netlify.app"
              target="_blank"
              rel="noopener noreferrer"
            >
              devy's art project
          ...
          <a
            className="link"
            href="https://github.com/devin-mullin/artiste"
            target="_blank"
            rel="noopener noreferrer"
          >
            frontend
          ...
          <br />
          <br />
          roadmap includes more interactive background animation, clickable
          objects that play different songs I wrote, and anything else I think
